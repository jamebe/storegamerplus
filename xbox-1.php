...
//Datos
        $this->Image('images/Cotizaciones/xbox-1-1.jpg',0,0,210);//imagen imagen principal  margen izq / altura top / tamaño
...
//-------------------------------------------PAGINA # 2--------------------------------------------//
     ...
     $pdf->AddPage3();
    $pdf->SetY(37);
$pdf->Image('images/Cotizaciones/xbox-1-2.jpg',0,0,210);//imagen Linea del footer  margen izq / altura top / tamaño
...
$fill=true;
    ...
    $pdf->Write(8,utf8_decode('LA PRIMERA DE XBOX'));
     $pdf->SetTextColor(64,64,65);//Opacidad del texto
    $pdf->Ln(10);//salto de linea  
    $pdf->SetFont('helvetica','', 12);//letra:   tipo / negrita=B  italica=I subrayado=U / tamaño
      $pdf->Write(12,utf8_decode(' también llamada Xbox Clásica, Xbox Original o 
Primera Xbox . Es una videoconsola de sobremesa
de sexta generación producida por Microsoft
y la primera de esta empresa, en colaboración
con Intel. Su principal característica es su
procesador central basado en el procesador 
Intel Pentium III. El sistema también incorpora
un lector de DVD, un disco duro interno, 
puerto ethernet y por último el sistema dispone
de cuatro conectores para los mandos. Las
unidades vendidas de este equipo fueron 24000000
...
//-------------------------------------------PAGINA # 3 -------------------------------------------//
    ...
    $pdf->AddPage();
    $pdf->SetY(37);
     $pdf->Image('images/Cotizaciones/xbox-1-3.jpg',0,0,210);//imagen Linea del footer  margen izq / altura top / tamaño
