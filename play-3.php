...
//Datos
        $this->Image('images/Cotizaciones/play-3-1.jpg',0,0,210);//imagen imagen principal  margen izq / altura top / tamaño
...
//-------------------------------------------PAGINA # 2--------------------------------------------//
     ...
     $pdf->AddPage3();
    $pdf->SetY(37);
$pdf->Image('images/Cotizaciones/play-3-2.jpg',0,0,210);//imagen Linea del footer  margen izq / altura top / tamaño
...
//-------------------------------------------PAGINA # 3 -------------------------------------------//
    ...
    $pdf->AddPage();
    $pdf->SetY(37);
     $pdf->Image('images/Cotizaciones/play-3-3.jpg',0,0,210);//imagen Linea del footer  margen izq / altura top / tamaño
...
$pdf->Cell(30,10,"PlayStation 3",1,0,'L');
        $pdf->Ln(10);//salto de linea
         $pdf->SetFillColor(6,47,72);//color de la celda
           $pdf->SetFont('helvetica','B',12);//letra:   tipo / negrita=B  italica=I subrayado=U / tamaño
         $pdf->SetTextColor(6,109,181);//Opacidad del texto
