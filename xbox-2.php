...
//Datos
        $this->Image('images/Cotizaciones/xbox-2-1.jpg',0,0,210);//imagen imagen principal  margen izq / altura top / tamaño
...
//-------------------------------------------PAGINA # 2--------------------------------------------//
     ...
     $pdf->AddPage3();
    $pdf->SetY(37);
$pdf->Image('images/Cotizaciones/xbox-2-2.jpg',0,0,210);//imagen Linea del footer  margen izq / altura top / tamaño
...
$fill=true;
    ...
    $pdf->Write(8,utf8_decode('LA 360 DE SIEMPRE'));
     $pdf->SetTextColor(64,64,65);//Opacidad del texto
    $pdf->Ln(10);//salto de linea  
    $pdf->SetFont('helvetica','', 12);//letra:   tipo / negrita=B  italica=I subrayado=U / tamaño
      $pdf->Write(10,utf8_decode('Es la segunda videoconsola de sobremesa de
la marca Xbox producida por Microsoft. Fue 
desarrollada en colaboración con IBM y ATI
(AMD) y lanzada en América del Sur, América
del Norte, Japón, Europa y Australia entre 
2005 y 2006. Su servicio Xbox Live (de pago) 
permite a los jugadores competir en línea y 
descargar contenidos como juegos arcade, 
demos, tráileres, programas de televisión y
películas. La Xbox 360 es la sucesora directa
de la Xbox, y compitió con la PlayStation 3
de Sony y Wii de Nintendo como parte de las 
...
//-------------------------------------------PAGINA # 3 -------------------------------------------//
    ...
    $pdf->AddPage();
    $pdf->SetY(37);
     $pdf->Image('images/Cotizaciones/xbox-2-3.jpg',0,0,210);//imagen Linea del footer  margen izq / altura top / tamaño
