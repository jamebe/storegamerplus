...
//Datos
        $this->Image('images/Cotizaciones/play-1-1.jpg',0,0,210);//imagen imagen principal  margen izq / altura top / tamaño
...
$fill=true;
$this->SetFont('helvetica','',23);//letra:   tipo / negrita=B  italica=I subrayado=U / tamaño
$this->Ln(48);//salto de linea
$this->cell(90,5,'       315 739 9574',0,'','L',0,'https://api.whatsapp.com/send?phone=573157399574&text=Hola,%20vi%20la%20cotizacion%20y%20estoy%20interesado');//Vinculo bases y soportes
...
//-------------------------------------------PAGINA # 2--------------------------------------------//
     ...
     $pdf->AddPage3();
    $pdf->SetY(37);
$pdf->Image('images/Cotizaciones/play-1-2.jpg',0,0,210);//imagen Linea del footer  margen izq / altura top / tamaño
...
//-------------------------------------------PAGINA # 3 -------------------------------------------//
    ...
    $pdf->AddPage();
    $pdf->SetY(37);
     $pdf->Image('images/Cotizaciones/play-1-3.jpg',0,0,210);//imagen Linea del footer  margen izq / altura top / tamaño
...
$pdf->Cell(30,10,"PlayStation 1",1,0,'L');
        $pdf->Ln(10);//salto de linea
         $pdf->SetFillColor(6,47,72);//color de la celda
           $pdf->SetFont('helvetica','B',12);//letra:   tipo / negrita=B  italica=I subrayado=U / tamaño
         $pdf->SetTextColor(6,109,181);//Opacidad del texto
